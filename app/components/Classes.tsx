  ...
  return (
    <div className='p-12 text-white'>
        ...
        <div className='flex justify-between mt-10'>
            <div className='w-[32%] h-88 rounded-3xl'>
                <Image src={classImage1} alt='' className='rounded-3xl h-full w-full object-contain filter grayscale'/>
            </div>
            <div className='flex flex-col justify-between p-8 bg-[#181920] w-[66%] rounded-3xl'>
        ...
        <div className='flex justify-between mt-8'>
            <div className='bg-[#181920] w-[32%] rounded-3xl text-2xl font-notable p-16 leading-10'>
                Credit and personalize your <i className='not-italic text-[#80D20E]'>workout</i>
            </div>
            <div className='w-[32%] h-88 rounded-3xl'>
                <Image src={classImage2} alt='' className='rounded-3xl object-contain filter grayscale'/>
            </div>
            <div className='w-[32%] h-88 rounded-3xl'>
                <Image src={classImage3} alt='' className='rounded-3xl object-contain filter grayscale'/>
            </div>
        </div>
    </div>
  )
