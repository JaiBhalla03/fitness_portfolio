  ...
  return (
    <div className='p-2 md:p-12 text-white'>
        ...
        <div className='flex flex-col gap-2 md:gap-0 md:flex-row justify-between mt-10'>
            ...
            <div className='flex flex-col gap-4 md:gap-0 justify-between p-8 bg-[#181920] w-full md:w-[66%] rounded-3xl'>
                <div className='flex flex-col md:flex-row gap-4 md:gap-0 justify-between'>
                    ...
                    <div className='bg-[#80D20E] text-center rounded-full py-4 px-8 cursor-pointer font-semibold text-blue-950'>
                        See All
                    </div>
                </div>
