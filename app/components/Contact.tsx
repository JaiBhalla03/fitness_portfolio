    ...
    return (
      <div className=''>
          ...
          <div className='mt-2 md:mt-0 md:translate-y-20 mx-2 md:mx-12 rounded-3xl flex flex-col gap-6 items-center py-24 relative bg-[#80D20E] 
              ...
              <div className='font-notable text-[2rem] md:text-[3.5rem]'>Let's Join Community</div>
              <div className='text-blue-950'>You are not alone, many have joined</div>
              
              <form className='rounded-lg bg-white p-2 flex flex-col items-center md:flex-row w-[90%] md:w-auto'>
                  <input placeholder='Your Email' className='h-full px-4 py-2 border-none outline-none w-full md:w-auto'/>
                  <button className='p-2 text-white font-notable rounded-lg bg-gray-800'>Join Now</button>
              </form>
          </div>
  
          {/* Footer */}
          <div className='bg-[#181920] flex flex-col md:flex-row w-full justify-between px-2 md:px-12 h-48 pb-10 text-white items-center md:items-end rounded-t-[6rem]'>
